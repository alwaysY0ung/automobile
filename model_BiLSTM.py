...
def BiLSTM(window_size = 150, batch_size = 64):
    # Input layer
    ...
    x = layers.LSTM(units=250)(x) # BiLSTM 2 (Output shape: 250)
    # x = layers.BatchNormalization()(x)

    x = layers.RepeatVector(150)(x) # Repeat Vector (Output shape: 150, 250)
